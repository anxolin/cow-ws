 ...
 */
  ...
  \**************************/
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      const typed_events_1 = __webpack_require__(/*! ./typed-events */ './build/typed-events.js')

      const debug = __webpack_require__(/*! debug */ './node_modules/debug/src/browser.js')('socket.io-client:manager')

      const Manager = /* #__PURE__ */(function (_typed_events_1$Stric) {
     ...
     */
          ...
          value: function open (fn) {
            ...
            const errorSub = (0, on_1.on)(socket, 'error', function (err) {
              debug('error')
              self.cleanup()
 ...
 */
      ...
      const Socket = /* #__PURE__ */(function (_typed_events_1$Stric) {
 ...
 */
      ...
      const StrictEventEmitter = /* #__PURE__ */(function (_Emitter) {
        _inherits(StrictEventEmitter, _Emitter)

        const _super = _createSuper(StrictEventEmitter)
 ...
 */
  ...
  \*****************************************************/
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      const installTimerFunctions = _require.installTimerFunctions
          ...
          value: function doWrite (data, fn) {
            ...
            var initIframe = function initIframe () {
              ...
              try {
                ...
                const html = '<iframe src="javascript:0" name="' + _this3.iframeId + '">'
 ...
 */
     ...
     */
          ...
          value: function onData (data) {
            ...
            const callback = function callback (packet) {
              ...
              if (_this2.readyState === 'opening' && packet.type === 'open') {
                _this2.onOpen()
  ...
  \*******************************************************************/
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      const nextTick = _require2.nextTick
